...
while (c == 1) {
    if (WebUI.verifyTextNotPresent(name, false,FailureHandling.OPTIONAL) == true) {
        if (WebUI.verifyElementPresent(findTestObject('Object Repository/USERS/USERSpage/nextPage_Pagination'), 1,FailureHandling.CONTINUE_ON_FAILURE) == true) {
            WebUI.click(findTestObject('Object Repository/USERS/USERSpage/nextPage_Pagination'))
        }
    } else {
